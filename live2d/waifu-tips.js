...
live2d_settings['waifuEdgeSide']        = 'right:120';     // 看板娘贴边方向，例如 'left:0'(靠左 0px), 'right:30'(靠右 30px)
...
live2d_settings['homePageUrl']          = 'https://yyovo.com';       // 主页地址，可选 'auto'(自动), '{URL 网址}'
live2d_settings['aboutPageUrl']         = 'https://yyovo.com/about/';   // 关于页地址, '{URL 网址}'
